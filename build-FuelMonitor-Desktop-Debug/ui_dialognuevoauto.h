...
public:
    ...
    void setupUi(QDialog *dialogNuevoAuto)
    {
        ...
        comboBox_3 = new QComboBox(dialogNuevoAuto);
        comboBox_3->setObjectName(QStringLiteral("comboBox_3"));
        comboBox_3->setGeometry(QRect(160, 150, 111, 27));
        ...
        comboBox_6 = new QComboBox(dialogNuevoAuto);
        comboBox_6->setObjectName(QStringLiteral("comboBox_6"));
        comboBox_6->setGeometry(QRect(160, 270, 111, 27));
